...
class Wildcard_test_harness extends CI_Controller
{
	...
	*/
	function index(){
		...
		//no htaccess: $test = $this->makeRequest(base_url() . 'starwar.php/unit_tests/wildcard_test_cases/digest', 'admin:1234');
