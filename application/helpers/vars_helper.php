...
if (!defined('GE_VARS')) {
    ...
    global $ge_messfields;
    global $ge_resource;     // 数据库字段，不能修改
    global $ge_pricelist;    //造价
    global $ge_requeriments;
    global $ge_CombatCaps;   //战斗数据
    global $ge_ProdGrid;
    global $ge_reslist;
...
//shield防御 attack攻击 sd快速开火
    ...
    $ge_reslist['build'] = array(1, 2, 3, 4, 12, 14, 15, 21, 22, 23, 24, 31, 33, 34, 44, 41, 42, 43);
    $ge_reslist['tech'] = array(106, 108, 109, 110, 111, 113, 114, 115, 117, 118, 120, 121, 122, 123, 124, 199);
    $ge_reslist['fleet'] = array(202, 203, 204, 205, 206, 207, 208, 209, 210, 211, 212, 213, 214, 215);
    $ge_reslist['defense'] = array(401, 402, 403, 404, 405, 406, 407, 408, 502, 503);
    $ge_reslist['officier'] = array(601, 602, 603, 604, 605, 606, 607, 608, 609, 610, 611, 612, 613, 614, 615);
    $ge_reslist['prod'] = array(1, 2, 3, 4, 12, 212);
}
